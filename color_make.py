...
df_c = pd.read_csv('cohens_d.csv', names = ["label_name:","Cohens_d"])
...
df_c['#No.'] = no
df_c['label_name:'] = 'ctx_' + df_c["label_name:"].astype(str)
...
df_c.columns = df_c.columns.str.replace('"','')
